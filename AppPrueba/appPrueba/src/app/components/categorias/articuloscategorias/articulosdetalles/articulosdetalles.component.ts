...
export class ArticulosdetallesComponent implements OnInit {
  ...
  constructor(private articulosService: ArticulosService, private route: ActivatedRoute, private uService: UsuariosService, private newDeseadoArticulos: DeseadosService) {
